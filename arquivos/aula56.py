# F3 abre um caixa de pesquisa para buscas de caracteres dentro do código
...
lista_frases_cruas = frase.split(',') # divide uma string em determinado caracter
...
# apenas string, lista e tuplas. Se caso colocar numeros no metodo join o codigo da erro, porque
# numeros não são iteráveis 
